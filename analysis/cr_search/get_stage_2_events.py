...
if __name__ == '__main__':
    ...
    ds.addROI('stage 2 cuts',{'p2p_gap_h':[-1, 95], 'above_normalized_map_max_line':[0,10000], 'above_snr_line':[0,10000]}) # Plus all cuts from stage 1
    ds.addROI('stage 2 partial cuts map',{'p2p_gap_h':[-1, 95], 'above_normalized_map_max_line':[0,10000]}) # Events that pass only the map max cut
