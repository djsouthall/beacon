...
if __name__ == '__main__':
    ...
    for runs in [numpy.arange(5780,5790)]:
        ...
        #test = ds.organizeEventDict(above_horizon_eventids_dict)
        ds.resetAllROI()
        ...
        if True:
            ...
            plot_params = [['phi_best_h','elevation_best_h'], ['hpol_peak_to_sidelobe_abovehorizon', 'vpol_peak_to_sidelobe_abovehorizon'],['hpol_peak_to_sidelobe_belowhorizon','hpol_peak_to_sidelobe_abovehorizon'], ['impulsivity_h','impulsivity_v'], ['cr_template_search_h', 'cr_template_search_v'], ['std_h', 'std_v'], ['p2p_h', 'p2p_v'], ['snr_h', 'snr_v'], ['hpol_max_possible_map_value','vpol_max_possible_map_value'], ['hpol_peak_to_sidelobe_abovehorizonSLICERDIVIDEhpol_peak_to_sidelobe_belowhorizon', 'vpol_peak_to_sidelobe_abovehorizonSLICERDIVIDEvpol_peak_to_sidelobe_belowhorizon'],['hpol_peak_to_sidelobe_abovehorizonSLICERSUBTRACThpol_peak_to_sidelobe_belowhorizon', 'vpol_peak_to_sidelobe_abovehorizonSLICERSUBTRACTvpol_peak_to_sidelobe_belowhorizon']]
