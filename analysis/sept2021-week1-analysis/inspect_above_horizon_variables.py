    ...
    for runs in [numpy.arange(5733,5974)]:
        ...
        if False:
            ...
            if False:
                ...
                plot_params = [['phi_best_h','elevation_best_h'],['hpol_max_map_value_belowhorizon','elevation_best_h'], ['hpol_max_map_value_belowhorizon','hpol_max_map_value_abovehorizon'],['similarity_count_h','similarity_count_v'], ['similarity_fraction_h','similarity_fraction_v'],['phi_best_h','event_rate_sigma_60.000Hz_20s']]
                print('Generating plots:')
