...
if __name__ == "__main__":
    ...
    #runs = numpy.arange(1600,1800)#numpy.array([1650,1728,1773,1774,1783,1784])#numpy.arange(1600,1750)#[1650]#numpy.arange(1600,1800)#[1650]#numpy.arange(3571,3630)#numpy.arange(3555,3571)#numpy.arange(1700,2200)#numpy.append(numpy.arange(1500,1700),numpy.arange(3530,3571))#numpy.arange(3530,3555)#numpy.arange(1500,1648)#numpy.array([186,189,364,365,366,367])#numpy.arange(1725,1800)#numpy.array([186,189])#numpy.array([364,365,366,367])#numpy.arange(1675,1725)#[::-1]
    
    #Some failed, running again starting at impulsivity. 
    runs = numpy.array([1650, 1651, 1652, 1653, 1654, 1655, 1656, 1659, 1665, 1666, 1667, 1682, 1690, 1691, 1791, 1792, 1793, 1794, 1795, 1796, 1797, 1798, 1799])

    #[1728,1773,1774,1783,1784]
    done_runs = numpy.array([])#numpy.array([1650])#numpy.array([1728,1773,1774,1783,1784])
    #runs = [1790]
