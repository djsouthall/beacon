...
if __name__ == "__main__":
    ...
    runs = numpy.arange(1650,1700)#numpy.array([186,189,364,365,366,367])#numpy.arange(1725,1800)#numpy.array([186,189])#numpy.array([364,365,366,367])#numpy.arange(1675,1725)#[::-1]
    #runs = [1790]
    ...
    for run in runs:
        ...
        command = os.environ['BEACON_ANALYSIS_DIR'] + 'analysis/save_time_delays.py %i 13'%(run)#'tools/data_handler.py %i'%(run)#'analysis/rf_bg_search.py %i'%(run)
