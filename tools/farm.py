...
if __name__ == "__main__":
    ...
    for run in runs:
        ...
        command = os.environ['BEACON_ANALYSIS_DIR'] + 'analysis/correlate_with_background_templates.py %i'%(run)#'tools/data_handler.py %i'%(run)#'analysis/rf_bg_search.py %i'%(run)
