...
if __name__ == "__main__":
    ...
    runs = numpy.append(numpy.arange(1500,1700),numpy.arange(3530,3555))#numpy.arange(3530,3555)#numpy.arange(1500,1648)#numpy.array([186,189,364,365,366,367])#numpy.arange(1725,1800)#numpy.array([186,189])#numpy.array([364,365,366,367])#numpy.arange(1675,1725)#[::-1]
    ...
    for run in runs:
        ...
        command = os.environ['BEACON_ANALYSIS_DIR'] + 'tools/data_handler.py %i'%(run)#'analysis/time_averaged_spectrum.py %i'%(run)#'tools/data_handler.py %i redo'%(run)#'analysis/cr_search/simple_cr_template_search.py %i 1'%(run)#'tools/data_handler.py %i'%(run)#'analysis/rf_bg_search.py %i'%(run)
