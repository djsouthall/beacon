...
def loadKnownPlaneDict(ignore_planes=[]):
    ...
    if ~numpy.isin('1705-55163',ignore_planes):
        known_planes['1705-55163'] = {  'eventids':numpy.array([[1705,55163],[1705,55296],[1705,55643]]),\
                        'known_flight':'a405d9',\
                        ...
                        'time_delays':{\
                            'hpol':numpy.array([[ -94.1068089 ,   79.02970008,  -13.60693431,  172.85498621, 79.79606765,  -92.93379733],\
                                                [-109.24647834,   57.47756735,  -40.86772339,  166.755326  , 68.42567541,  -98.31401043],\
                            ...
                            'vpol':numpy.array([[ -91.0569788 ,   75.46374488,   -8.44568337,  166.63020476, 82.45489389,  -83.9250684 ],\
                                               [ -10.05661927, -396.52483399, -193.56255061,  120.94531382, 304.74840809, -246.11346932],\
                        ...
                        'max_corrs':{\
                            'hpol':numpy.array([[0.84648652, 0.89595556, 0.8819821 , 0.90708408, 0.85060955, 0.89920087], \
                                                [0.88654404, 0.92736262, 0.86184698, 0.8841094 , 0.83151015, 0.92514495], \
                            ...
                            'vpol':numpy.array([[0.73876297, 0.67328208, 0.69787771, 0.71509814, 0.72462139, 0.73146428], \
                                                [0.1904543 , 0.17052859, 0.1992131 , 0.24349455, 0.2661463 , 0.24585243], \
    ...
    if ~numpy.isin('1759-510',ignore_planes):
        known_planes['1759-510'] = {  'eventids':numpy.array([[1759,510]]),\
                        ...
                        'time_delays':{\
                            ...
                            'vpol':numpy.array([[ -7.69495595, 192.26441779,  47.98399364,  -5.7242965 , -0.45356448, -47.87451256]])},\
                        'max_corrs':{\
                            'hpol':numpy.array([[0.66419262, 0.62868594, 0.74188733, 0.73069807, 0.44745382,  0.51406763]]),\
                            'vpol':numpy.array([[0.08025048, 0.08516104, 0.10616005, 0.32432773, 0.33182955,  0.35333642]])}}
    ...
    if ~numpy.isin('1774-178',ignore_planes):
        known_planes['1774-178'] = {  'eventids':numpy.array([[1774,178],[1774,381],[1774,533],[1774,1348],[1774,1485]]),\
                        'known_flight':'a1c2b3',\
                        'signal_classification':'HF',\
                        'baselines':{'hpol':[[0,1],[0,2],[0,3],[1,2],[1,3],[2,3]],'vpol':[[1,2],[1,3],[2,3]]},\
                        'time_delays':{\
                            'hpol':numpy.array([[-115.61202118,  -42.35353806, -119.02157483,   73.1959225 , -3.9413189 ,  -76.73059739],\
                                                [-112.45270999,  -26.11905781, -105.08619728,   86.09904986,  7.6793158 ,  -78.66997653],\
                                                [-134.8024906 ,   55.56946851, -100.87899575,  133.39487671, 29.05940684, -101.7861247 ],\
                            ...
                            'vpol':numpy.array([[ -18.08001846, 1010.33833279,  116.19070689,   67.19010322, -1.18865173,  -68.5664368 ],\
                                                [  12.27752119, -101.7861247 , -212.23689493,   80.49987459,-11.02630884,  -90.66597494],\
                                                [ -28.16791804,  -16.35960148,   64.14027311,  124.762, 32.34383926,  -90.82237648],\
                        ...
                        'max_corrs':{\
                            'hpol':numpy.array([[0.77470334, 0.80067311, 0.81435014, 0.73398618, 0.72465197,  0.8592991 ],\
                                                [0.81679328, 0.77673194, 0.8168854 , 0.74341533, 0.80441464,  0.62463562],\
                                                [0.43990579, 0.53479781, 0.23753962, 0.33960117, 0.6283666 ,  0.43317699],\
                            ...
                            'vpol':numpy.array([[0.0753522 , 0.06178115, 0.10010959, 0.43601496, 0.37651565,  0.38387265],\
                                                [0.08623415, 0.04797674, 0.09093487, 0.55771447, 0.46547365,  0.52091612],\
                                                [0.05164525, 0.08650669, 0.09591176, 0.03032012, 0.26509627,  0.1847743 ],\
